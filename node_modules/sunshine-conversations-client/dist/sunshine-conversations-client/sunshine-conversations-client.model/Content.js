...
var _FormResponseMessageField = _interopRequireDefault(require("./FormResponseMessageField"));
...
var Content = /*#__PURE__*/function () {
  ...
  return _createClass(Content, [{
    ...
    key: "setSubmitted",
    value: function setSubmitted(submitted) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fields')) {
          obj['fields'] = _ApiClient["default"].convertToType(data['fields'], [_FormResponseMessageField["default"]]);
        }
 ...
 * @member {Boolean} submitted
 */
_FormMessage["default"].prototype['submitted'] = undefined;
/**
 * true if the message should block the chat input on Web Messenger.
 * @member {Boolean} blockChatInput
 */
 ...
 * @member {String} mediaType
 */
_ImageMessage["default"].prototype['mediaType'] = undefined;
/**
 * The size of the media in bytes.
 * @member {Number} mediaSize
 */
_ImageMessage["default"].prototype['mediaSize'] = undefined;
/**
 * An optional description of the image for accessibility purposes. The field will be saved by default with the file name as the value.
 * @member {String} altText
 */
