...
var TwitterAllOf = /*#__PURE__*/function () {
   ...
   */
  function TwitterAllOf(tier, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret) {
   ...
   */
  return _createClass(TwitterAllOf, [{
    key: "getType",
    value:
    /**
    ...
    key: "initialize",
    value: function initialize(obj, tier, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret) {
      obj['tier'] = tier;
...
var _default = exports["default"] = TwitterAllOf;