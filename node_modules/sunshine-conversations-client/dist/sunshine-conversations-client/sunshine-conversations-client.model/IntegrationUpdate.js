...
var _UnityUpdate = _interopRequireDefault(require("./UnityUpdate"));
...
var IntegrationUpdate = /*#__PURE__*/function () {
  ...
  function IntegrationUpdate() {
    ...
    _UnityUpdate["default"].initialize(this);
   ...
   */
  return _createClass(IntegrationUpdate, [{
    key: "getDisplayName",
    value:
    /**
    ...
    key: "setClientEmail",
    value: function setClientEmail(clientEmail) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _UnityUpdate["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('clientEmail')) {
          obj['clientEmail'] = _ApiClient["default"].convertToType(data['clientEmail'], 'String');
        }
 ...
 * @member {String} projectId
 */
_AndroidUpdate["default"].prototype['projectId'] = undefined;
/**
 * Your client email from your generated private key file.
 * @member {String} clientEmail
 */
_AndroidUpdate["default"].prototype['clientEmail'] = undefined;
/**
 * Your private key from your generated private key file.
 * @member {String} privateKey
 */
_AndroidUpdate["default"].prototype['privateKey'] = undefined;
/**
 * Your server key from the fcm console.
 * @member {String} serverKey
 */
 ...
 * @member {String} displayName
 */
_UnityUpdate["default"].prototype['displayName'] = undefined;
/**
 * Allows users to create more than one conversation on the Unity integration.
 * @member {Boolean} canUserCreateMoreConversations
 */
_UnityUpdate["default"].prototype['canUserCreateMoreConversations'] = undefined;
...
var _default = exports["default"] = IntegrationUpdate;