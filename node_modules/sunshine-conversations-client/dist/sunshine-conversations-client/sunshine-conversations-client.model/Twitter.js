...
var Twitter = /*#__PURE__*/function () {
   ...
   */
  function Twitter(type, tier, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret) {
    _classCallCheck(this, Twitter);
    _Integration["default"].initialize(this, type);
    _TwitterAllOf["default"].initialize(this, tier, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret);
  ...
  return _createClass(Twitter, [{
    ...
    key: "initialize",
    value: function initialize(obj, type, tier, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret) {
      obj['tier'] = tier;
